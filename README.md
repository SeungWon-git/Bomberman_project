...
- 폭발의 경우에는 폭탄을 놓고 지연시간 이후에 폭발이 일어나기 때문에 타이머 스레드를 이용하여 폭발을 시기를 설정 → 폭발은 또한 일정시간 동안 머물러서 플레이어를 피격할 수 있음 (*폭발 당시에만 피해주는 방식이 아님)
  * 이때, 플레이어가 폭발 지역에 계속 머물러 한 번의 폭발에 여러번 피격 당하지는 않도록 하기 위해 피격 이후 일정 무적시간을 부여해 준다.
* 코드 보기:  [서버 맵 정보 타일 형태로 저장](https://github.com/SeungWon-git/Bomberman_project/blob/main/Multi_game_server/Multi_game_server/Multi_Server.cpp#L23C1-L23C8), [맵 타일 정보 구조체](https://github.com/SeungWon-git/Bomberman_project/blob/main/Multi_game_server/Multi_game_server/stdafx.h#L123), [서버 '플레이어-객체' 간 충돌 체크 확인 함수](https://github.com/SeungWon-git/Bomberman_project/blob/main/Multi_game_server/Multi_game_server/Multi_Server.cpp#L597), [서버 '폭발-플레이어' 간 충돌 체크 확인 함수](https://github.com/SeungWon-git/Bomberman_project/blob/main/Multi_game_server/Multi_game_server/Multi_Server.cpp#L550), [서버 폭탄 설치](https://github.com/SeungWon-git/Bomberman_project/blob/main/Multi_game_server/Multi_game_server/Multi_Server.cpp#L914), [폭탄 작동 설정](https://github.com/SeungWon-git/Bomberman_project/blob/main/Multi_game_server/Multi_game_server/Multi_Server.cpp#L195), [플레이어 무적시간 설정](https://github.com/SeungWon-git/Bomberman_project/blob/main/Multi_game_server/Multi_game_server/Multi_Server.cpp#L588)
